...
NOTA:
Provider.GPT se utiliza temporalmente para representar este
proveedor porque el enum actual todavía solo contempla GEMINI
y GPT.

Esta decisión es provisional y se resolverá posteriormente
ampliando correctamente el dominio de Provider.
"""
